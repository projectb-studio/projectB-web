...
DROP INDEX IF EXISTS pb_users_profile_created_at_idx;
DROP INDEX IF EXISTS pb_users_profile_blocked_idx;
ALTER TABLE pb_users_profile DROP CONSTRAINT IF EXISTS pb_users_profile_admin_memo_len_chk;
